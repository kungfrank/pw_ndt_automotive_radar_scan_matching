...
namespace pcl
{
  ...
  class WeightedNormalDistributionsTransform2D : public Registration<PointSource, PointTarget>
  {
    ...
    public:
        ...
        typedef boost::shared_ptr< WeightedNormalDistributionsTransform2D<PointSource, PointTarget> > Ptr;
        typedef boost::shared_ptr< const WeightedNormalDistributionsTransform2D<PointSource, PointTarget> > ConstPtr;

      /** \brief Empty constructor. */
      WeightedNormalDistributionsTransform2D ()
      ...
      virtual ~WeightedNormalDistributionsTransform2D () {}
