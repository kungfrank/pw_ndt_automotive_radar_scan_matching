/*
This is the modify radar_ego_motion code, with ackerman model assumption.
*/
...
int main (int argc, char** argv)
{
  ...
  ros::init (argc, argv, "radar_ego_motion_ack");
  ros::NodeHandle nh;
  ...
  pub = nh.advertise<nav_msgs::Odometry> ("vel_ack", 1);
